...
class TestStudent(unittest.TestCase):
    ...
    * instance in avariabkle called old_end_date
    * Call a method named apply_extension that will take a number of days as
    * an argument on the student instance to update the end_date
    * Assert whether the instance's end_date equals the old end date plus the
    ...
    * has a parameter calles days
    * Use the timedelta medthod from datetime to update the end_date property
